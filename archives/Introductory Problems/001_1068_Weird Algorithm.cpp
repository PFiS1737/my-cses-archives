...
// multiplies it by three and adds one. The algorithm repeats this, until n is one. For
// example, the sequence for n=3 is as follows:
// $$ 3 \rightarrow 10 \rightarrow 5 \rightarrow 16 \rightarrow 8 \rightarrow 4
// \rightarrow 2 \rightarrow 1 $$ Your task is to simulate the execution of the algorithm
